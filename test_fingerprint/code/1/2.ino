...
void loop(){
   ...
   if(stringComplete){
      ...
      if(receivedString.getAdress() == arduinoAddress){

          Serial.println("inut string je" + inputString);

          if (receivedString.getCommand() == "FpGt"){
          ...
          */
          else if (receivedString.getCommand() == "FpEn"){
          ...
          else if (receivedString.getCommand() == "FpRm"){
               num1 = receivedData.charAt(0);
               for(int i=1; i<(receivedData.length()); i++){
                   num1 += receivedData.charAt(i);
                    }
          ...
          else if (receivedString.getCommand() == ""){          {
